...
function logoImpressao(width,height){
		...
		var width = width; //width of the above image
		var height = height; // height of the above image
		SunmiInnerPrinter.setAlignment(1); aguardar(56);
	    SunmiInnerPrinter.lineWrap(1); aguardar(56);
		SunmiInnerPrinter.printBitmap(base64Data, width, height); aguardar(500);	
}
...
function iniciandoImpressao(){	
		SunmiInnerPrinter.printerInit(); aguardar(100);
        SunmiInnerPrinter.printerStatusStartListener(); aguardar(56);
}
